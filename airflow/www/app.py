...
def create_app(config=None, testing=False):
    ...
    from airflow.shareit.www.pipeline import pipeline_api
    app.register_blueprint(pipeline_api, url_prefix='/pipeline')
    from airflow.shareit.www.workflow import workflow_api
    app.register_blueprint(workflow_api, url_prefix='/pipeline/workflow')
    configure_logging()
