...
from wtforms.fields import (IntegerField, SelectField, TextAreaField, PasswordField,
                            StringField, Field, BooleanField)
...
class ConnectionForm(DynamicForm):
    ...
    extra__grpc__scopes = StringField(
        lazy_gettext('Scopes (comma separated)'),
        widget=BS3TextFieldWidget())
    extra__kubernetes_configuration_file_path = StringField(
        lazy_gettext('Config File Path'),
        widget=BS3TextFieldWidget())
    extra__kubernetes_configuration_yaml = StringField(
        lazy_gettext('Config Yaml'),
        widget=BS3PasswordFieldWidget())
    extra__kubernetes_configuration_json = StringField(
        lazy_gettext('Config Json'),
        widget=BS3PasswordFieldWidget())
