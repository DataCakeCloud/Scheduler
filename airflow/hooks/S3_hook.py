...
class S3Hook(AwsHook):
    ...
    def get_conn(self, region_name=None):
        return self.get_client_type(client_type='s3',region_name=region_name)
    ...
    def load_string(self,
        ...
        :param s3_region: s3 region name
        ...
        self._upload_file_obj(file_obj=file_obj,
                              key=key,
                              s3_region=s3_region,
                              bucket_name=bucket_name,
                              replace=replace,
    ...
    def _upload_file_obj(self,
        ...
        client = self.get_conn(region_name=s3_region)
