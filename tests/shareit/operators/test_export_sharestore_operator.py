...
from airflow.shareit.operators.export_sharestore_operator import ExportSharestoreOperator
...
class ExportSharestoreOperatorTest(unittest.TestCase):
    ...
    def test_task_Pool(self):
        sharestore = ExportSharestoreOperator(
            ...
            backup_db='backup_db',
            output_path='s3://cbs-sharestore-test-sg/cbs/sharestore/parquet_input_dir/tjk_table',
            output_region='obs.ap-southeast-3.myhuaweicloud.com',
            output_platform='obs',
